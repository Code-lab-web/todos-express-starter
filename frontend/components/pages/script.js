...
const todaysWeatherFeature = (London) => {
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&APPID=548773e920254208b83a2e2bdadb8f0e`
  )
    .then((response) => {
...
const weatherForecastData = (London) => {
  fetch(
...
switchFavoriteCity.addEventListener("click", getNextCity);
